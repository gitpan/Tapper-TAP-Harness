...
#     NO_META => q[1]
#     PL_FILES => {  }
#     PREREQ_PM => { IO::Scalar=>q[0], Directory::Scratch=>q[0], Tapper::Test=>q[0], Test::Perl::Critic=>q[0], Archive::Tar=>q[0], File::Slurp=>q[0], Moose=>q[0], Test::Harness=>q[3.22], TAP::DOM=>q[0], YAML::Tiny=>q[0], IO::String=>q[0], ExtUtils::MakeMaker=>q[6.42], TAP::Parser=>q[0], TAP::Formatter::HTML=>q[0.04], TAP::Parser::Aggregator=>q[0], Test::More=>q[0] }
#     VERSION => q[3.000004]
...
DISTVNAME = Tapper-TAP-Harness-3.000004
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Archive-Tar" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Directory-Scratch" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="TAP-DOM" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="TAP-Formatter-HTML" VERSION="0,04,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="TAP-Parser" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="TAP-Parser-Aggregator" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Tapper-Test" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Test-Harness" VERSION="3,22,0,0" />' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="YAML-Tiny" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
